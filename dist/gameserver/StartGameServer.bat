...
echo.
"%JAVA_EXE%" -server -Dfile.encoding=UTF-8 -Xmx8G -cp config;.././libs/* l2.gameserver.GameServer

REM Debug ...
REM "%JAVA_EXE%" -Dfile.encoding=UTF-8 -cp config;./* -Xmx1G -Xnoclassgc -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=7456 l2.gameserver.GameServer
