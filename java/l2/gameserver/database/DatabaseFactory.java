...
public class DatabaseFactory{
	...
	private static final MariaDbPoolDataSource DATABASE_POOL = new MariaDbPoolDataSource(Config.DATABASE_GAME_URL + "&user=" + Config.DATABASE_GAME_USER + "&password=" + Config.DATABASE_GAME_PASSWORD + "&maxPoolSize=" + Config.DATABASE_MAX_CONN);
