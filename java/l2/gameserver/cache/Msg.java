...
public abstract class Msg
{
	...
	public static final SystemMessage ONLY_LEVEL_SUP_10_CAN_RECOMMEND = new SystemMessage(898);
	public static final SystemMessage YOU_CURRENTLY_DO_NOT_HAVE_RECOMMENDATION = new SystemMessage(3206);
	...
	public static final SystemMessage THE_ANGEL_NEVIT_HAS_BLESSED_YOU_FROM_ABOVE__YOU_ARE_IMBUED_WITH_FULL_VITALITY_AS_WELL_AS_A_VITALITY_REPLENISHING_EFFECT_AND_SHOULD_YOU_DIE_YOU_WILL_NOT_LOSE_EXP = new SystemMessage(3266);
	public static final SystemMessage YOU_ARE_STARTING_TO_FEEL_THE_EFFECTS_OF_NEVIT_S_BLESSING = new SystemMessage(3267);
	public static final SystemMessage YOU_ARE_FURTHER_INFUSED_WITH_THE_BLESSINGS_OF_NEVIT__CONTINUE_TO_BATTLE_EVIL_WHEREVER_IT_MAY_LURK = new SystemMessage(3268);
	public static final SystemMessage NEVIT_S_BLESSING_SHINES_STRONGLY_FROM_ABOVE__YOU_CAN_ALMOST_SEE_HIS_DIVINE_AURA = new SystemMessage(3269);
	public static final SystemMessage NEVIT_S_BLESSING_HAS_ENDED__CONTINUE_YOUR_JOURNEY_AND_YOU_WILL_SURELY_MEET_HIS_FAVOR_AGAIN_SOMETIME_SOON = new SystemMessage(3275);
