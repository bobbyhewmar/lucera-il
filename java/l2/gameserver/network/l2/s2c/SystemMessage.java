...
public class SystemMessage extends L2GameServerPacket
{
	...
	public static final int S1_IS_MAKING_AN_ATTEMPT_AT_RESURRECTION_WITH_S2_EXPERIENCE_POINTS_DO_YOU_WANT_TO_CONTINUE_WITH_THIS_RESURRECTION = 1510;
	...
	{
		args.add(new Arg(11, Integer.valueOf(id)));
		return this;
	}
	
	public SystemMessage addNpcName(int id)
	{
		args.add(new Arg(2, Integer.valueOf(1000000 + id)));
		return this;
	}
