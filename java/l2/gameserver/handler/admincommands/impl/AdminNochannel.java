...
public class AdminNochannel implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(Enum comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		if(banChatCountPerDay > 0)
		{
			...
			String penalty;
			int penaltyCount = 0;
			if((penalty = activeChar.getVar("penaltyChatCount")) != null)
			{
			...
			{
				if(System.currentTimeMillis() - LastBanChatDayTime < 86400000)
				{
				...
				else
				{
					...
					{
						int add_count = activeChar.getPlayerAccess().BanChatBonusCount;
