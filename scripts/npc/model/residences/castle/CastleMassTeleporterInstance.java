...
public class CastleMassTeleporterInstance extends NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		_teleportTask = ThreadPoolManager.getInstance().schedule(new TeleportTask(), isAllTowersDead() ? 480000 : 30000);
		showChatWindow(player, "residence2/castle/CastleTeleportDelayed.htm");
	}
	...
	private class TeleportTask extends RunnableImpl
	{
		...
		{
			Functions.npcShoutCustomMessage(CastleMassTeleporterInstance.this, "NpcString.THE_DEFENDERS_OF_S1_CASTLE_WILL_BE_TELEPORTED_TO_THE_INNER_CASTLE", (Object[]) new Object[] {getCastle().getName()});
