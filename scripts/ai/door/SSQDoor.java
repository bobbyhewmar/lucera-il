...
{
	private static final Territory room1 = new Territory().add((Shape) new Rectangle(-89696, 217741, -88858, 218085).setZmin(-7520).setZmax(-7320));
	private static final Territory room2 = new Territory().add((Shape) new Rectangle(-88773, 220765, -88429, 219596).setZmin(-7520).setZmax(-7320));
	private static final Territory room3 = new Territory().add((Shape) new Rectangle(-87485, 220463, -86501, 220804).setZmin(-7520).setZmax(-7320));
	private static final Territory room4 = new Territory().add((Shape) new Rectangle(-85646, 219054, -84787, 219408).setZmin(-7520).setZmax(-7320));
	private static final Territory room5 = new Territory().add((Shape) new Rectangle(-87739, 216646, -87159, 217842).setZmin(-7520).setZmax(-7320));
