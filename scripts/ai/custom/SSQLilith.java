...
{
	private final String[] chat = {"You, such a fool! The victory over this war belongs to Shilen!!!", "How dare you try to contend against me in strength? Ridiculous.", "Anakim! In the name of Great Shilien, I will cut your throat!", "You cannot be the match of Lilith. I'll teach you a lesson!"};
	...
	protected boolean thinkActive()
	{
		if(_lastChatTime < System.currentTimeMillis())
		{
			...
			_lastChatTime = System.currentTimeMillis() + 15000;
		}
