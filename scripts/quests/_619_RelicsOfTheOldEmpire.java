...
public class _619_RelicsOfTheOldEmpire extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			if(event.equals("explorer_ghost_a_q0619_09.htm"))
			{
				if(st.getQuestItemsCount(7254) < 1000)
				{
					return st.getQuestItemsCount(7075) > 0 ? "explorer_ghost_a_q0619_06.htm" : "explorer_ghost_a_q0619_07.htm";
				}
				st.takeItems(7254, 1000);
				st.giveItems(Recipes[Rnd.get(Recipes.length)], 1);
				return "explorer_ghost_a_q0619_09.htm";
			}
			if(event.equals("explorer_ghost_a_q0619_10.htm"))
			{
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		st.rollAndGive(7254, 1, (double) Broken_Relic_Part_chance.intValue());
		if(npcId > 20000)
		{
