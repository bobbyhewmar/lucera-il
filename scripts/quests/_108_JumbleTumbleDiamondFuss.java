...
public class _108_JumbleTumbleDiamondFuss extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		{
			htmltext = cond == 2 && st.getQuestItemsCount(REEPS_CONTRACT) == 1 ? "carrier_torocco_q0108_01.htm" : cond == 3 && st.getQuestItemsCount(ELVEN_WINE) > 0 ? "carrier_torocco_q0108_03.htm" : cond == 7 && st.getQuestItemsCount(GEM_BOX1) == 1 ? "carrier_torocco_q0108_04.htm" : "carrier_torocco_q0108_05.htm";
		}
		else if(npcId == 30529)
		{
			...
			{
				htmltext = cond == 4 ? "miner_maron_q0108_02.htm" : "miner_maron_q0108_03.htm";
			}
		}
		else if(npcId == 30526)
		{
			...
			{
				htmltext = cond == 9 && st.getQuestItemsCount(BRONPS_LETTER) > 0 ? "blacksmith_bronp_q0108_07.htm" : "blacksmith_bronp_q0108_08.htm";
			}
		}
		else if(npcId == 30521)
		{
			...
			{
				htmltext = cond == 10 && st.getQuestItemsCount(BERRY_TART) > 0 ? "warehouse_murphrin_q0108_02.htm" : "warehouse_murphrin_q0108_03.htm";
			}
		}
		else if(npcId == 30522)
		{
			...
			{
				htmltext = cond == 11 && st.getQuestItemsCount(BAT_DIAGRAM) > 0 ? "warehouse_airy_q0108_02.htm" : cond == 12 && st.getQuestItemsCount(STAR_DIAMOND) > 0 ? "warehouse_airy_q0108_03.htm" : "warehouse_airy_q0108_04.htm";
			}
		}
		return htmltext;
	}
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == 20480 && cond == 11 && st.getQuestItemsCount(BAT_DIAGRAM) > 0 && st.getQuestItemsCount(STAR_DIAMOND) == 0 && Rnd.chance(50))
		{
